...
public class TeacherDashboardFragment extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        name_tv.setText(Utils.getPrefValue(getActivity(),"userName","Guest"));
        ...
        add_quiz_btn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void fetchData(){
        ...
        api.getQuizes(Utils.getPrefValue(getActivity(), "userID", ""), new Callback<List<QuizApi>>() {
            ...
            public void success(List<QuizApi> s, retrofit.client.Response response) {
                ...
                QuizAdapter adapter = new QuizAdapter(getActivity(), s);
