 ...
 */
public class ShortAnswerQuestionFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.short_answer_question_fragment, container, false);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.check_btn :
                ...
                firstanswer = editText.getText().toString();
                showFeedback(true);
    ...
    public class MyCountDownTimer extends CountDownTimer {
        ...
        public void onTick(long millisUntilFinished) {
           ...
           int sec = (int) (millisUntilFinished/1000);
            ...
            time_tv.setText(String.valueOf(minutes)+":" +String.valueOf(seconds) + " min") ;
        }
    }
    ...
    public void showReport(){
        ...
        int score = (int) Math.ceil(100.0/ quiz.getQuestions().size()*correctCount);
