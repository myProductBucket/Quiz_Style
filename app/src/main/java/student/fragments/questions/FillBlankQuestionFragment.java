 ...
 */
public class FillBlankQuestionFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fill_the_blank_question_fragment, container, false);
    ...
    public void setUI(View root){
        ...
        check_btn= (ImageView)root.findViewById(R.id.check_btn);
        check_btn.setOnClickListener(this);

        editText = (EditText)root.findViewById(R.id.answer_et);
        ...
        switch (v.getId()){
            ...
            case R.id.check_btn :
                ...
                if(firstanswer.equals(""))
                    firstanswer = quiz.getQuestions().get(index).getAnswers().get(0).getText();

                boolean isCorrect = false ;

                for(int i = 0; i<quiz.getQuestions().get(index).getAnswers().size();i++){

                    if(editText.getText().toString().equalsIgnoreCase(quiz.getQuestions().get(index).getAnswers().get(i).getText())&&!isCorrect){
